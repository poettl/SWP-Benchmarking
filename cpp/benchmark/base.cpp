...
#include "../bubbleSort/header/bubbleSort.h"
#include "../insertionSort/header/insertionSort.h"
#include "../radixSort/header/radixSort.h"
...
int main()
{
	...
	for (unsigned int i = 0; i < iterations; ++i)
	{
		...
		vector<int> bubbleSortVector = data;
		...
		vector<int> insertionSortVector = data;
		...
		vector<int> radixSortVector = data;
